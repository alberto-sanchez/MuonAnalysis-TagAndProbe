...
LowPtTriggerFlagsPhysics = cms.PSet(
    ...
    Dimuon13_PsiPrime = cms.string("!triggerObjectMatchesByCollection('hltL3MuonCandidates').empty()"
                                      + " && triggerObjectMatchesByCollection('hltL3MuonCandidates').at(0).hasFilterLabel('hltDisplacedmumuFilterDimuon13PsiPrime')"),
    Dimuon8_PsiPrime_Barrel = cms.string("!triggerObjectMatchesByCollection('hltL3MuonCandidates').empty()"
                                      + " && triggerObjectMatchesByCollection('hltL3MuonCandidates').at(0).hasFilterLabel('hltDisplacedmumuFilterDimuon8PsiPrimeBarrel')"),
    Dimuon13_Upsilon = cms.string("!triggerObjectMatchesByCollection('hltL3MuonCandidates').empty()"
                                  + " && triggerObjectMatchesByCollection('hltL3MuonCandidates').at(0).hasFilterLabel('hltDisplacedmumuFilterDimuon13Upsilon')"),
    Dimuon8_Upsilon_Barrel = cms.string("!triggerObjectMatchesByCollection('hltL3MuonCandidates').empty()"
...
LowPtTriggerFlagsEfficienciesTag = cms.PSet(
   ...
   ########## Mu + Track ########## 
   Mu7p5_Track2_Upsilon_MU = cms.string(  "!triggerObjectMatchesByCollection('hltL3MuonCandidates').empty()"
                                       + " && triggerObjectMatchesByCollection('hltL3MuonCandidates').at(0).hasFilterLabel('hltL3fLMu7p5TrackL3Filtered7p5')"
                                       + " && triggerObjectMatchesByCollection('hltL3MuonCandidates').at(0).hasFilterLabel('hltMu7p5Track2UpsilonTrackMassFiltered')"
                                       ),
   Mu7p5_Track3p5_Upsilon_MU = cms.string("!triggerObjectMatchesByCollection('hltL3MuonCandidates').empty()"
                                       + " && triggerObjectMatchesByCollection('hltL3MuonCandidates').at(0).hasFilterLabel('hltL3fLMu7p5TrackL3Filtered7p5')"
                                       + " && triggerObjectMatchesByCollection('hltL3MuonCandidates').at(0).hasFilterLabel('hltMu7p5Track3p5UpsilonTrackMassFiltered')"
                                       ),
   Mu7p5_Track7_Upsilon_MU = cms.string(  "!triggerObjectMatchesByCollection('hltL3MuonCandidates').empty()"
                                       + " && triggerObjectMatchesByCollection('hltL3MuonCandidates').at(0).hasFilterLabel('hltL3fLMu7p5TrackL3Filtered7p5')"
                                       + " && triggerObjectMatchesByCollection('hltL3MuonCandidates').at(0).hasFilterLabel('hltMu7p5Track7UpsilonTrackMassFiltered')"
                                       ),
   ########## Mu + L2Mu ##########
   Mu7p5_L2Mu2_Upsilon_MU = cms.string(   "!triggerObjectMatchesByCollection('hltL3MuonCandidates').empty()"
                                       + " && triggerObjectMatchesByCollection('hltL3MuonCandidates').at(0).hasFilterLabel('hltL3fMu7p5L2Mu2L3Filtered7p5')"
                                       + " && triggerObjectMatchesByCollection('hltL3MuonCandidates').at(0).hasFilterLabel('hltMu7p5L2Mu2UpsilonTrackMassFiltered')"
                                       ),
   ########## Mu + TkMu ##########
   ...
   Mu16TkMu0Onia_L3_MU = cms.string(   "!triggerObjectMatchesByCollection('hltL3MuonCandidates').empty()"                   
                                       + " && triggerObjectMatchesByCollection('hltL3MuonCandidates').at(0).hasFilterLabel('hltL3fL1sMu14erorMu16L1f0L2f0L3Filtered16')"
                                       ),
   )

LowPtTriggerFlagsEfficienciesProbe = cms.PSet(
    ########## Mu + Track ##########
    Mu7p5_Track2_Upsilon_TK = cms.string(  "!triggerObjectMatchesByCollection('hltTracksIter').empty()"
                                        + " && triggerObjectMatchesByCollection('hltTracksIter').at(0).hasFilterLabel('hltMu7p5Track2UpsilonTrackMassFiltered')"
                                        ),
    Mu7p5_Track3p5_Upsilon_TK = cms.string("!triggerObjectMatchesByCollection('hltTracksIter').empty()"
                                        + " && triggerObjectMatchesByCollection('hltTracksIter').at(0).hasFilterLabel('hltMu7p5Track3p5UpsilonTrackMassFiltered')"
                                        ),
    Mu7p5_Track7_Upsilon_TK = cms.string(  "!triggerObjectMatchesByCollection('hltTracksIter').empty()"
                                        + " && triggerObjectMatchesByCollection('hltTracksIter').at(0).hasFilterLabel('hltMu7p5Track7UpsilonTrackMassFiltered')"
                                        ),
    ########## Mu + L2Mu ##########
    ...
    Mu7p5_L2Mu2_Upsilon_L2 = cms.string(   "!triggerObjectMatchesByCollection('hltL2MuonCandidates').empty()"
                                        + " && triggerObjectMatchesByCollection('hltL2MuonCandidates').at(0).hasFilterLabel('hltL2fDoubleMu2L2PreFiltered2')"
                                        + " && triggerObjectMatchesByCollection('hltL2MuonCandidates').at(0).hasFilterLabel('hltMu7p5L2Mu2UpsilonTrackMassFiltered')"
                                        ),
   ########## Mu + TkMu ##########
    ...
    Mu16TkMu0Onia_L2 = cms.string(      "!triggerObjectMatchesByCollection('hltL2MuonCandidates').empty()"
                                        + " && triggerObjectMatchesByCollection('hltL2MuonCandidates').at(0).hasFilterLabel('hltL2fL1sMu14erorMu16L1f0L2Filtered0')"
                                        ),
...
LowPtTriggerFlagsEfficienciesProbe_L2 = cms.PSet(
    ########## Mu + Track ##########
    Mu7p5_Track2_Upsilon_TK = cms.string("!triggerObjectMatchesByCollection('hltL2MuonCandidates').empty()"
                                      #+ " && triggerObjectMatchesByCollection('hltL2MuonCandidates').at(0).hasFilterLabel('hltMu7p5Track2JpsiTrackMassFiltered')"
                                      ),
    Mu7p5_Track3p5_Upsilon_TK = cms.string("!triggerObjectMatchesByCollection('hltL2MuonCandidates').empty()"
                                        #+ " && triggerObjectMatchesByCollection('hltL2MuonCandidates').at(0).hasFilterLabel('hltMu7p5Track3p5JpsiTrackMassFiltered')"
                                        ),
    Mu7p5_Track7_Upsilon_TK = cms.string("!triggerObjectMatchesByCollection('hltL2MuonCandidates').empty()"
