...
if   "CMSSW_5_3_" in os.environ['CMSSW_VERSION']:
    ...
    process.source.fileNames = [
        # BPH MC 50ns
        #'/store/mc/RunIISpring15DR74/UpsilonMuMu_UpsilonPt6_TuneCUEP8M1_13TeV-pythia8-evtgen/AODSIM/Asympt50ns_MCRUN2_74_V9A-v1/30000/FADF1320-D030-E511-A066-0CC47A4DED22.root',
        #'/store/mc/RunIISpring15DR74/UpsilonMuMu_UpsilonPt6_TuneCUEP8M1_13TeV-pythia8-evtgen/AODSIM/Asympt50ns_MCRUN2_74_V9A-v1/30000/FCA6DF7F-CC30-E511-BC66-0002C90F80DA.root',
        #'/store/mc/RunIISpring15DR74/UpsilonMuMu_UpsilonPt6_TuneCUEP8M1_13TeV-pythia8-evtgen/AODSIM/Asympt50ns_MCRUN2_74_V9A-v1/40000/002E7D1E-F130-E511-98EC-6C3BE5B51168.root',
        #'/store/mc/RunIISpring15DR74/UpsilonMuMu_UpsilonPt6_TuneCUEP8M1_13TeV-pythia8-evtgen/AODSIM/Asympt50ns_MCRUN2_74_V9A-v1/40000/060A32A7-EF30-E511-BC0D-6C3BE5B5F228.root',
        # 25 ns
        #'/store/mc/RunIISpring15DR74/UpsilonMuMu_UpsilonPt6_TuneCUEP8M1_13TeV-pythia8-evtgen/AODSIM/Asympt25ns_MCRUN2_74_V9-v1/40000/E40F17AB-AD32-E511-92F9-6C3BE5B58198.root',
        #'/store/mc/RunIISpring15DR74/UpsilonMuMu_UpsilonPt6_TuneCUEP8M1_13TeV-pythia8-evtgen/AODSIM/Asympt25ns_MCRUN2_74_V9-v1/40000/E48883FE-CE32-E511-92B6-001E67A3FF1F.root',
        #'/store/mc/RunIISpring15DR74/UpsilonMuMu_UpsilonPt6_TuneCUEP8M1_13TeV-pythia8-evtgen/AODSIM/Asympt25ns_MCRUN2_74_V9-v1/50000/02114D49-4331-E511-8547-00259073E3F2.root',
        '/store/mc/RunIISpring15DR74/UpsilonMuMu_UpsilonPt6_TuneCUEP8M1_13TeV-pythia8-evtgen/AODSIM/Asympt25ns_MCRUN2_74_V9-v1/50000/0401BD79-C431-E511-92DB-B499BAAC00E0.root',
        ]
...
process.HLTBoth = process.triggerResultsFilter.clone(triggerConditions = ['HLT_Mu*_L2Mu*', 'HLT_Mu*_Track*_Upsilon*', 'HLT_Mu*_TkMu*']) # asked by Ilse 
...
process.HLTBoth_withDimuon = process.triggerResultsFilter.clone(triggerConditions = [ 'HLT_Mu*_L2Mu*', 'HLT_Mu*_Track*_Upsilon*', 'HLT_Mu*', 'HLT_Dimuon*' ])
...
process.tpPairs = cms.EDProducer("CandViewShallowCloneCombiner",
    cut = cms.string('8.6 < mass < 11.4 && abs(daughter(0).vz - daughter(1).vz) < 1'),
...
process.tagMuonsMCMatch = cms.EDProducer("MCMatcher", # cut on deltaR, deltaPt/Pt; pick best by deltaR
    ...
    matched = cms.InputTag("goodGenMuonsFromUpsilon"),   # mc-truth particle collection
...
process.tnpSimpleSequence = cms.Sequence(
    process.goodGenMuonsFromUpsilon *
...
process.tpPairsSta = process.tpPairs.clone(decay = "tagMuons@+ probeMuonsSta@-", cut = "5 < mass < 14")
...
if True: # turn on for tracking efficiency using gen particles as probe
    process.probeGen = cms.EDFilter("GenParticleSelector",
                                    ...
                                    #cut = cms.string("abs(pdgId) == 13 && pt > 2 && abs(eta) < 2.4 && numberOfMothers == 1 && motherRef.pdgId == 553"),
                                    src = cms.InputTag("goodGenMuonsFromUpsilon"),
                                    cut = cms.string(""),
                                    )
    process.tpPairsTkGen = process.tpPairs.clone(decay = "tagMuons@+ probeGen@-", cut = '5 < mass < 14')
    ...
    process.genToProbeMuonsMatch.matched = cms.InputTag("goodGenMuonsFromJpsi")
    ...
    process.genToSoftIDNoTMOSTMatch.matched = cms.InputTag("goodGenMuonsFromJpsi")
    ...
    process.genToSoftIDMatch.matched = cms.InputTag("goodGenMuonsFromJpsi")
    # 
    ...
    process.tagAndProbeTkGen = cms.Path( 
        ...
        process.nverticesModule    * # added by gpetruc: https://github.com/cms-analysis/MuonAnalysis-TagAndProbe/pull/21/files#diff-0
        process.tpTreeGen
        )
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("tnpUpsN_officialBPHMC.root")
                                   )
...
if True: # enable and do cmsRun tp_from_aod_MC.py /eos/path/to/run/on [ extra_postfix ] to run on all files in that eos path 
    ...
    if scenario:
	    ...
	    #files in local
            ...
            import os.path
            process.TFileService.fileName = "tnpUpsN_MC_%s.root" % os.path.basename(scenario)
        else:
            process.TFileService.fileName = "tnpUpsN_MC_%s.root" % scenario
    if len(args) > 1:
