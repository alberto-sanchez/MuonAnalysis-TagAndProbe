...
if   "CMSSW_5_3_" in os.environ['CMSSW_VERSION']:
	...
	# 25 ns problem with pair_probemultiplicity
        '/store/mc/RunIISpring15DR74/JpsiToMuMu_OniaMuonFilter_TuneCUEP8M1_13TeV-pythia8/AODSIM/Asympt25ns_MCRUN2_74_V9-v2/30000/52DA6630-6527-E511-8382-0025905C42A8.root'
        ]
...
from MuonAnalysis.TagAndProbe.common_variables_jpsi_cff import *
process.load("MuonAnalysis.TagAndProbe.common_modules_cff")
#process.tkTracksNoZ.dRCandSoftActivityCone = cms.double(0.0)
#process.muonMiniIsoPUCharged.dRCandSoftActivityCone = cms.double(0.0)
#process.muonMiniIsoNeutrals.dRCandSoftActivityCone = cms.double(0.0)
#process.muonMiniIsoPhotons.dRCandSoftActivityCone = cms.double(0.0)
