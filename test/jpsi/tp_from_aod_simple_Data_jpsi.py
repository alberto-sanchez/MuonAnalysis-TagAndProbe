...
process.maxEvents = cms.untracked.PSet( input = cms.untracked.int32(5000) ) # 3' for 1k vents on Run2015C, 350KB in 7' for 5k events, 2.5MB in 20' for 10k events, 90MB in 26h for 1M events on Run2015C   
